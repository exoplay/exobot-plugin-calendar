Contributing to exobot-plugin-calendar
======================

So you want to contribute to exobot-plugin-calendar? Fantastic! Here's a brief overview on
how best to do so.
...
[create an issue](https://github.com/exoplay/exobot-plugin-calendar/issues) before putting
...
1. [Fork the repository](https://github.com/exoplay/exobot-plugin-calendar/fork_select) to
  your Github account.
...
exobot-plugin-calendar is MIT licensed. See details in the LICENSE file. This is a very permissive
